...
object CreateNoteDestination : NavigationDestination {
    ...
    override val titleRes = R.string.create_note
}
    ...
    Scaffold(
        topBar = {
            HelloReminderTopAppBar(
                title = stringResource(CreateNoteDestination.titleRes),
...
fun ItemEntryBody(
    ...
    onItemValueChange: (ItemNote) -> Unit,
    onSaveClick: () -> Unit,
...
@Composable
fun ItemInputForm(
    itemDetails: ItemNote,
    modifier: Modifier = Modifier,
    onValueChange: (ItemNote) -> Unit = {},
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = {
                Text(stringResource(R.string.item_price_req))
            },
            colors = OutlinedTextFieldDefaults.colors(
                focusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                unfocusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
...
private fun ItemEntryScreenPreview() {
    HelloReminderTheme {
        ItemEntryBody(itemUiState = ItemUiState(
            ItemNote(
                name = "Home", description = "This is my descriptions", type = "On going"
            )
